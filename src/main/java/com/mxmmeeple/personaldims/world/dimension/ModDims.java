...
public class ModDims {
	...
	public static final ResourceLocation PDIM_ID = new ResourceLocation(PersonalDims.MODID, "pdim");
    public static final ResourceKey<Level> PDIM_WORLD = ResourceKey.create(Registry.DIMENSION_REGISTRY, PDIM_ID);
    public static final ResourceKey<DimensionType> PDIM_TYPE = ResourceKey.create(Registry.DIMENSION_TYPE_REGISTRY, PDIM_ID);
